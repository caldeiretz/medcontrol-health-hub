...
const CTA = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-green-600 py-[54px]">
        ...
        <div className="text-center space-y-8">
          <div className="space-y-6">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Junte-se a diversas pessoas que já transformaram seu cuidado com a saúde
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Button 
              ...
              className="border-2 border-white font-semibold text-lg px-8 py-4 hover:bg-white transition-all duration-300 group text-blue-700"
            >
