...
const mockBloodPressureData = [
  ...
  { date: '04/05', systolic: 125, diastolic: 85 },
  { date: '05/05', systolic: 121, diastolic: 79 },
  { date: '06/05', systolic: 119, diastolic: 80 },
  { date: '07/05', systolic: 120, diastolic: 82 },
];

const mockGlucoseData = [
  { date: '01/05', glucose: 95 },
  { date: '02/05', glucose: 98 },
  { date: '03/05', glucose: 102 },
  { date: '04/05', glucose: 96 },
  { date: '05/05', glucose: 93 },
  { date: '06/05', glucose: 99 },
  { date: '07/05', glucose: 97 },
];

const mockHeartRateData = [
  { date: '01/05', heartRate: 72 },
  { date: '02/05', heartRate: 74 },
  { date: '03/05', heartRate: 70 },
  { date: '04/05', heartRate: 76 },
  { date: '05/05', heartRate: 68 },
  { date: '06/05', heartRate: 72 },
  { date: '07/05', heartRate: 71 },
];
...
const formSchema = z.object({
  ...
  systolic: z.string().optional().refine(
    (val) => !val || (Number(val) >= 60 && Number(val) <= 250), 
    { message: "Valor inválido (60-250)" }
  ),
  diastolic: z.string().optional().refine(
    (val) => !val || (Number(val) >= 40 && Number(val) <= 150), 
    { message: "Valor inválido (40-150)" }
  ),
  glucose: z.string().optional().refine(
    (val) => !val || (Number(val) >= 40 && Number(val) <= 500), 
    { message: "Valor inválido (40-500)" }
  ),
  heartRate: z.string().optional().refine(
    (val) => !val || (Number(val) >= 40 && Number(val) <= 200), 
          ...
          <div className="overflow-auto">
            <table className="w-full min-w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {activeTab === 'blood-pressure' && mockBloodPressureData.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      ...
                      ) : item.systolic <= 100 || item.diastolic <= 60 ? (
                ...
                {activeTab === 'glucose' && mockGlucoseData.map((item, index) => (
                  <tr key={index}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {item.date}
                    </td>
                ...
                {activeTab === 'heart-rate' && mockHeartRateData.map((item, index) => (
                  <tr key={index}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {item.date}
                    </td>
